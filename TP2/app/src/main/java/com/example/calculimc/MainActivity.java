...
public class MainActivity extends AppCompatActivity {
    ...
    private String interpreteIMC(float imc) {
        ...
        if( imc <= 18.5 && imc > 16.5) return "maigreur.";
        if(imc <= 25 && imc > 18.5) return "corpulence normale.";
        if(imc <= 30 && imc > 25) return "surpoids.";
        if(imc <= 35 && imc > 30) return "obésité modérée.";
        if(imc <= 40 && imc > 35) return "obésité sévère.";
