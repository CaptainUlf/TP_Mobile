    ...
    public CharSequence getPageTitle(int position) {
        ...
        switch (position) {
            case 0:
                ...
                icone = mContext.getResources().getDrawable(R.drawable.darkest);
                break;
            case 1:
                titre = mContext.getString(R.string.titre_section1).toUpperCase(l);
                icone = mContext.getResources().getDrawable(R.drawable.doom);
                break;
            case 2:
                titre = mContext.getString(R.string.titre_section2).toUpperCase(l);
                icone = mContext.getResources().getDrawable(R.drawable.hades);
                break;
        }
